...
import qs.core.widgets.widgetCanvas
...
import qs.shell.background.widgets
import qs.shell.background.widgets.clock
import qs.shell.background.widgets.weather
