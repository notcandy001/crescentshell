...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            StyledToolTip { text: Translation.tr("Prevents abrupt increments and restricts volume limit") }
        }
        ConfigRow {
    ...
    ContentSection {
        ...
        ConfigRow {
            ColumnLayout {
                ContentSubsectionLabel { text: Translation.tr("Weeb") }
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            StyledToolTip { text: Translation.tr("Enable if you want clocks to show seconds accurately") }
        }
